...
class ChildForm extends Component {
    constructor(props) {
        super(props)
        this.state = { results: [], loading: true, age: this.props.values.age, days: "", style: "", needsValidation: false};
        this.loadClasses();
    }
        ...
        return <div className="container">
            ...
            <div className="card">
              <div className="card-body">
                <h2 className="display-3 sortaBlack ">
                  How old is your child?
                </h2>
                <p className="text-muted">
                  Select your child's age and to show only classes for
                  that age
                </p>
                <form>
                  <div className="row">
                    <div className="col">
                      <div className="form-group">
                        <select name="age" onChange={this.handleChange} className={this.state.needsValidation ? "form-control custom-select border border-danger" : "form-control custom-select"} value={values.age}>
